---
title: 'Check fish data from transect based methods (e.g. stereo-DOVs or ROVs) from EventMeasure and/or Generic data'
...
# Introduction
This script will take fish annotation data (either exported from EventMeasure or "Generic" format, see format requirements [here](https://globalarchivemanual.github.io/CheckEM/articles/manuals/CheckEM_user_guide.html)) and check for any errors in the annotation.
