...
write.csv(all.mod.fits[ , -2], file = paste(outdir, paste(name, "Length_all-mod-fits.csv", sep = "_"), sep = "/"))
write.csv(all.var.imp, file = paste(outdir, paste(name, "Length_all-var-imp.csv", sep = "_"), sep = "/"))
